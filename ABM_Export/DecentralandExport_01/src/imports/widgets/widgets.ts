...
export class WidgetTextBox extends Widget{
  ...
  constructor(parentUI: Widget | UIShape, textData: TextProperties = null){
    ...
    this.textBoxImage = new UIImage(container, new Texture('assets/UI_Bubble_Talk.png'))
    this.textBoxImage.name = 'textBoxImage'
    this.textBoxImage.sourceWidth = 799,
    this.textBoxImage.sourceHeight = 287,
    this.textBoxImage.width = '799px',
    this.textBoxImage.height = '287px',
    this.textBoxImage.vAlign = 'bottom'
    this.textBoxImage.hAlign = 'center'
/*
    this.faceImage = new UIImage(container, new Texture("assets/UI_Icon_Info.png"))
    this.faceImage.visible = false
...
export class WidgetComfirm extends Widget{
  ...
  constructor(parentUI: Widget | UIShape){
    ...
    this.buttonComfirmImage.visible = false
    ...
    this.comfrimTextUI.visible = false
